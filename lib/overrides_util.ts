 ...
 *
 * Root-level string overrides (e.g. `{ "foo": "1.0.0" }`) are global and apply
...
export function getChildOverrides(
  ...
  // Collect root-level global (string) overrides — these apply everywhere
