...
export function parse(version, loose) {
...
export function valid(version, loose) {
  const v = parse(version, loose);
  return v ? v.version : null;
}


export function clean(version, loose) {
  const s = parse(version.trim().replace(/^[=v]+/, ''), loose);
  return s ? s.version : null;
}

export default function SemVer(version, loose) {
  if (version instanceof SemVer) {
...
export function Comparator(comp, loose) {
...
export function Range(range, loose) {
...
export function toComparators(range, loose) {
...
export function satisfies(version, range, loose) {
  try {
...
export function maxSatisfying(versions, range, loose) {
  let max = null;
  let maxSV = null;
  let rangeObj;
  try {
...
export function minSatisfying(versions, range, loose) {
  let min = null;
  let minSV = null;
  let rangeObj;
  try {
...
export function validRange(range, loose) {
  try {
...
export function ltr(version, range, loose) {
  return outside(version, range, '<', loose);
}

// Determine if version is greater than all the versions possible in the range.
export function gtr(version, range, loose) {
  return outside(version, range, '>', loose);
}

export function outside(version, range, hilo, loose) {
...
export function prerelease(version, loose) {
  const parsed = parse(version, loose);
  return (parsed && parsed.prerelease.length) ? parsed.prerelease : null;
}

export function intersects(r1, r2, loose) {
